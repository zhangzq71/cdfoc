...
Features (tp constant rotation):
  - Uses state=5 (ST_POS_TP), firmware trap planner handles accel/decel
  - Target speed in RPM, configurable acceleration and direction
  - Real-time position / speed feedback
